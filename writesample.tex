...
\end{itemize}
For a simple \textit{ceteris paribus} analysis let's ignore sovereign default risk and denomination risk, assumed constant across periods. Let's see if it holds in the data.
...
The interested reader can consult the pseudo-``online appendix'' to the analysis \href{https://doi.org/10.82029/2025014}{\textcolor{blue}{\underline{here}}}.
